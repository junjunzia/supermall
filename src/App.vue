<template>
    ...
    <div id="nav">
        ...
        <tab-bar>
            ...
            <TabBarItem path="/profile" active-color="#BDBCF0">
...
<script>
    ...
    export default {
        data() {
            return {
                tabList: [
                    {path: "/home", activeC: "blue", title: "首页"},
                    {path: "/classfy", activeC: "", title: "分类"},
                    {path: "/shopcar", activeC: "green", title: "购物车"},
                    {path: "/profile", activeC: "yellow", title: "我的"}
                ]
            }
        },
